...
export default defineComponent({
  components: {About, Classes, Contact, Dancing, Footer, Header, Hours, Banner, Testimonial},
})
...
#my_slider button.carousel-control-prev
{
  position: absolute;
  left: 585px;
  top: 108%;
...
#my_slider button.carousel-control-next
{
  position: absolute;
  left: 660px;
  top: 108%;
